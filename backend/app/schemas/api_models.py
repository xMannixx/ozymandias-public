...
class TurnRequest(BaseModel):
    ...
    provider: Literal["deepseek", "openai", "ollama", "gemini", "lmstudio"] | None = None
...
class UserSettingsResponse(BaseModel):
    ...
    preferred_provider: Literal["deepseek", "openai", "ollama", "gemini", "lmstudio"] | None
...
class UpdateSettingsRequest(BaseModel):
    ...
    preferred_provider: Literal["deepseek", "openai", "ollama", "gemini", "lmstudio"] | None = None
